			...
			<div className="flex flex-col md:flex-row gap-8 items-start">
				<div className="w-full md:w-1/3 flex flex-col items-center">
					<div className="relative w-48 h-48 rounded-full overflow-hidden border-4 border-primary/10 mb-4">
						<Image src="/Marko.png" alt={CONTACT_INFO.name} fill className="object-cover" priority />
					</div>
				...
				<div className="w-full md:w-2/3">
					<div className="text-center md:text-left">
						...
						<h2 className="text-xl text-muted-foreground mb-6">Senior Full-Stack Developer</h2>
					</div>
					<Card>
						<CardContent>
